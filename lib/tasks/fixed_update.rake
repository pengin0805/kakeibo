namespace :fixed_update do
  ...
  task monthly: :environment do
    ...
    FixedCost.create(fixecate_id: 8 ,fixecate_name_id: 11 ,price: 1980 ,month:  Date.new(today.year,today.month))
    ...
    FixedCost.create(fixecate_id: 8 ,fixecate_name_id: 13 ,price: 1490 ,month:  Date.new(today.year,today.month))
    FixedCost.create(fixecate_id: 6 ,fixecate_name_id: 13 ,price: 16500 ,month:  Date.new(today.year,today.month))
  end
end
